...
public class IdealTurretManagerTest
{
    ...
    public void testHistoryManager()
    {
        ...
        double turret_angle = 20;
        IStateManager.RobotState state_at_time;

        // Nothing has been filled in yet, we should expect invalid data
        Assert.assertFalse(mStateManager.canCalculate(timestamp0));

        // Add data for t0
        mStateManager.saveRobotState(timestamp0, robot_x, robot_y, robot_angle, turret_angle);
        ...
        Assert.assertEquals(65, state_at_time.mAbsoluteAngle, 0);
        ...
        robot_angle = -50;
        turret_angle = 30;
        mStateManager.saveRobotState(timestamp1, robot_x, robot_y, robot_angle, turret_angle);
        ...
        Assert.assertEquals(-20, state_at_time.mAbsoluteAngle, 0);
