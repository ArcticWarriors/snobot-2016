...
public class DriveTurnProfile extends Command
{
    private IDriveTrain mDriveTrain;
    private PathFollower mPathFollower;

    public DriveTurnProfile(IDriveTrain aDriveTrain, ISetpointIterator aSetpointIterator, double aKV, double aKA, double aKP, double aDistance,
