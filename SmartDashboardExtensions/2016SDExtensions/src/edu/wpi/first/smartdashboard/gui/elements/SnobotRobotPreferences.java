 ...
 */
public class SnobotRobotPreferences extends StaticWidget implements ITableListener {

    public static final String NAME = "2016 Robot Preferences";
    ...
    public void init() {
        ...
        save.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fc.showOpenDialog(SnobotRobotPreferences.this) == JFileChooser.APPROVE_OPTION) {
    ...
    private class PreferenceTableModel extends AbstractTableModel {
        ...
        public boolean validateKey(String key) {
            if (key.isEmpty()) {
                JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "The key cannot be empty", "Bad Key", JOptionPane.ERROR_MESSAGE);
                return false;
            }
            return true;
        }
            ...
            switch (typeIndex) {
                case 0: // Boolean
                    ...
                    if (lower.equals("y") || lower.equals("yes") || lower.equals("t") || lower.equals("true") || lower.equals("on") || lower.equals("1"))
                        ...
                        JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Invalid boolean value; expected one of yes, true, 1, no, false, 0", "Bad Value", JOptionPane.ERROR_MESSAGE);
                    break;
                    }
                case 1: // Number
                    try {
                        ...
                        JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Invalid number value", "Bad Value", JOptionPane.ERROR_MESSAGE);
                    }
                    break;
                case 2: // String
                    try {
                        ...
                        JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Invalid string: " + e.getMessage(), "Bad Value", JOptionPane.ERROR_MESSAGE);
                    }
                case 3: // Raw
                    {
                    value = value.trim();
                    if (value.equals("[]"))
                        return new byte[0];
                    if (!value.startsWith("[")) {
                        JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Invalid array: missing [", "Bad Value", JOptionPane.ERROR_MESSAGE);
                        break;
                    }
                    if (!value.endsWith("]")) {
                        JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Invalid array: missing ]", "Bad Value", JOptionPane.ERROR_MESSAGE);
                    ...
                    for (int i=0; i < arr.length; i++) {
                        try {
                            ...
                            JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Invalid number value at index " + i + ": '" + arr[i].trim() + "'", "Bad Value", JOptionPane.ERROR_MESSAGE);
                            return null;
                        }
                    }
                    return barr;
                ...
                case 4: // Boolean[]
                    ...
                    for (int i=0; i < arr.length; i++) {
                        ...
                        if (lower.equals("y") || lower.equals("yes") || lower.equals("t") || lower.equals("true") || lower.equals("on") || lower.equals("1"))
                            ...
                            JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Invalid boolean value at index " + i + ": '" + arr[i].trim() + "'; expected one of yes, true, 1, no, false, 0", "Bad Value", JOptionPane.ERROR_MESSAGE);
                            return null;
                        }
                    }
                    return barr;
                ...
                case 6: // String[]
                    ...
                    if (value.contains("]]]")) {
                        JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Invalid array: unescaped ]", "Bad Value", JOptionPane.ERROR_MESSAGE);
                        break;
                    }
                    ...
                    for (int i=0; i < arr.length; i++) {
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Invalid string at index " + i + ": " + e.getMessage(), "Bad Value", JOptionPane.ERROR_MESSAGE);
                        }
                    }
                    return arr;
                    }
                ...
                if (entry != null) {
                    ...
                    if (!oldName.equals(aValue.toString())) {
                        if (!values.containsKey(aValue.toString())) {
                            ...
                            JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "An entry with the key " + aValue + " already exists", "Duplicate Key", JOptionPane.ERROR_MESSAGE);
                        }
                    }
                }
        ...
        public void save(String filename) {
            try {
                ...
                JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Error saving file:" + e.getMessage(), "Save Preferences", JOptionPane.ERROR_MESSAGE);
            }
        }
        ...
        public void load(String filename) {
            ...
            try {
                ...
                if (warnings.length > 0) {
                    JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Warning loading file:" + Arrays.toString(warnings), "Load Preferences", JOptionPane.WARNING_MESSAGE);
                }
            } catch (PersistentException e) {
                JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "Error loading file:" + e.getMessage(), "Load Preferences", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
            ...
            addButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    if (!values.containsKey(getKey())) {
                        ...
                        JOptionPane.showMessageDialog(SnobotRobotPreferences.this, "An entry with the key " + getKey() + " already exists", "Duplicate Key", JOptionPane.ERROR_MESSAGE);
                    }
                }
            });
