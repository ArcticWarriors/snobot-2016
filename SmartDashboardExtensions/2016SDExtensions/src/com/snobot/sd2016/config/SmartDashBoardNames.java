package com.snobot.sd2016.config;

public class SmartDashBoardNames
{
    // Drivetrain
    public static final String sLEFT_DRIVE_MOTOR_SPEED = "Left Drive Motor";
    public static final String sRIGHT_DRIVE_MOTOR_SPEED = "Right Drive Motor";
