...
import com.snobot.sd2016.vision.MjpegReceiver.ImageReceiver;
...
public class SnobotVideoStreamViewerExtension extends StaticWidget {
    ...
    public static final String NAME = "SnobotVideoStreamViewerExtension";
    ...
    // public void run() {
    //
    // String xxx = "http://127.0.0.1:1180";
    ...
    // ByteArrayInputStream tmpStream = new
    ...
    // public final StringProperty ipProperty = new StringProperty(this, "Camera
    // IP Address or mDNS name", "axis-camera.local");
