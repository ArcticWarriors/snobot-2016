...
public class TestCoordinateGui extends BaseCoordinateGui
{
    ...
    public TestCoordinateGui()
    {
        super(CENTER_POINT_X, CENTER_POINT_Y);
        
        mFieldLayer = new FieldImageLayer(FIELD_IMAGE_PATH, mConverter, FIELD_WIDTH, FIELD_HEIGHT);
        mRobotLayer = new RobotLayer(mCoordinateDataProvider, mConverter, ROBOT_WIDTH, ROBOT_HEIGHT);
        mCoordinateLayer = new CoordinateLayer(mCoordinateDataProvider, mConverter);
